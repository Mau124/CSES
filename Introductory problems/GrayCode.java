...
public class GrayCode {
	...
	static short[] code = new short[16];
	...
	static void generateCode(int start, int size) {
		...
		code[start] = 0;
		generateCode(start+1, size);
		code[start] = 1;
		generateCodeReverse(start+1, size);
	}
	
	static void generateCodeReverse(int start, int size) {
